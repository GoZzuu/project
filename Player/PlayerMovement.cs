...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if ((weapon.Attacking /*|| TargetedWalk*/) && weapon.Targeted || weapon.Targeted && weapon.CurrentWeaponRanged() && weapon.Attacking)
        {
            Vector3 temp = weapon.Target.position - transform.position;
    ...
    void AnimationsInput(float h, float v)
    {
        ...
        animator.SetBool("isAttacking", weapon.Attacking);
